...
cntools_startup_normalize_session() {
  ...
  CNTOOLS_WALLET_PAY_CRED_FILENAME="${WALLET_PAY_CRED_FILENAME:-payment.cred}"
  CNTOOLS_WALLET_PAY_SCRIPT_CRED_FILENAME="${WALLET_PAY_SCRIPT_CRED_FILENAME:-payment.script.cred}"
  ...
  CNTOOLS_WALLET_STAKE_CRED_FILENAME="${WALLET_STAKE_CRED_FILENAME:-stake.cred}"
  ...
  CNTOOLS_TIMEZONE="${BLOCKLOG_TZ:-UTC}"
  export CNTOOLS_TIMEZONE
  ...
  export CNTOOLS_WALLET_PAY_CRED_FILENAME
  export CNTOOLS_WALLET_PAY_SCRIPT_CRED_FILENAME
