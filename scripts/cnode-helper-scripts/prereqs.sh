...
curl -s -f -m ${CURL_TIMEOUT} -o dbsync.sh.tmp ${URL_RAW}/scripts/koios-helper-scripts/dbsync.sh
...
curl -s -f -m ${CURL_TIMEOUT} -o setup-koios.sh ${URL_RAW}/scripts/koios-helper-scripts/setup-koios.sh
