...
download_cnodebins() {
  ...
  if [[ "${SKIP_DBSYNC_DOWNLOAD}" == "N" ]]; then
    ...
    curl -m 200 -sfL https://github.com/IntersectMBO/cardano-db-sync/releases/download/13.2.0.1/cardano-db-sync-13.2.0.1-linux.tar.gz -o cnodedbsync.tar.gz || err_exit "  Could not download cardano-db-sync release 13.2.0.0 from GitHub!"
