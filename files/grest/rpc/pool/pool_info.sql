...
BEGIN
    ...
    SELECT FLOOR(supply / (SELECT p_optimal_pool_count FROM grest.epoch_info_cache WHERE epoch = _epoch_no))::bigint INTO _total_supply FROM grest.totals(_epoch_no);
