...
BEGIN
  ...
  LEFT JOIN (
    ...
    WHERE
      ...
      AND (RESERVE.TX_ID > LATEST_WITHDRAWAL_TX
        OR BLOCK.EPOCH_NO >= LATEST_WITHDRAWAL_EPOCH)) RESERVES_T ON TRUE
  LEFT JOIN (
    SELECT
    ...
    WHERE
      ...
      AND (TREASURY.TX_ID > LATEST_WITHDRAWAL_TX
        OR BLOCK.EPOCH_NO >= LATEST_WITHDRAWAL_EPOCH)) TREASURY_T ON TRUE;
  END IF;
END;
$$;
