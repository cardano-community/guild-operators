...
WALLET_PAY_CRED_FILENAME="custom-payment.cred"
WALLET_PAY_SCRIPT_CRED_FILENAME="custom-payment.script.cred"
WALLET_STAKE_SK_FILENAME="custom-stake.skey"
WALLET_STAKE_ADDR_FILENAME="custom-reward.addr"
WALLET_STAKE_CRED_FILENAME="custom-stake.cred"
WALLET_STAKE_SCRIPT_CRED_FILENAME="custom-stake.script.cred"
WALLET_DERIVATION_PATH_FILENAME="custom-derivation.path"
WALLET_GOV_DREP_VK_FILENAME="custom-drep.vkey"
WALLET_GOV_DREP_SK_FILENAME="custom-drep.skey"
WALLET_GOV_HW_DREP_SK_FILENAME="custom-drep.hwsfile"
WALLET_GOV_DREP_ID_FILENAME="custom-drep.id"
WALLET_GOV_DREP_SCRIPT_FILENAME="custom-drep.script"
WALLET_GOV_DREP_REGISTER_CERT_FILENAME="custom-drep-reg.cert"
WALLET_GOV_DREP_RETIRE_CERT_FILENAME="custom-drep-ret.cert"
UPDATE_CHECK="Y"
ENABLE_KOIOS="Y"
KOIOS_API=""
...
cntools_action_main() {
  ...
  [[ -o posix ]] && posix_state="Y"
  {
    ...
    printf "%s\n" "wallet_payment_credential_file=${CNTOOLS_WALLET_PAY_CRED_FILENAME}"
    printf "%s\n" "wallet_payment_script_credential_file=${CNTOOLS_WALLET_PAY_SCRIPT_CRED_FILENAME}"
    ...
    printf "%s\n" "wallet_stake_credential_file=${CNTOOLS_WALLET_STAKE_CRED_FILENAME}"
    printf "%s\n" "wallet_stake_script_credential_file=${CNTOOLS_WALLET_STAKE_SCRIPT_CRED_FILENAME}"
    printf "%s\n" "wallet_derivation_file=${CNTOOLS_WALLET_DERIVATION_PATH_FILENAME}"
    printf "%s\n" "wallet_drep_verification_file=${CNTOOLS_WALLET_DREP_VKEY_FILENAME}"
    printf "%s\n" "wallet_drep_signing_file=${CNTOOLS_WALLET_DREP_SKEY_FILENAME}"
    printf "%s\n" "wallet_drep_hardware_file=${CNTOOLS_WALLET_HW_DREP_SKEY_FILENAME}"
    printf "%s\n" "wallet_drep_id_file=${CNTOOLS_WALLET_DREP_ID_FILENAME}"
    printf "%s\n" "wallet_drep_script_file=${CNTOOLS_WALLET_DREP_SCRIPT_FILENAME}"
    printf "%s\n" "wallet_drep_register_file=${CNTOOLS_WALLET_DREP_REGISTER_CERT_FILENAME}"
    printf "%s\n" "wallet_drep_retire_file=${CNTOOLS_WALLET_DREP_RETIRE_CERT_FILENAME}"
...
run_session_matrix_tests() {
  ...
  for implementation in cnode dingo amaru; do
    ...
    for mode in local light offline; do
      ...
      assert_trace_value wallet_payment_credential_file "custom-payment.cred"
      assert_trace_value wallet_payment_script_credential_file \
        "custom-payment.script.cred"
      ...
      assert_trace_value wallet_stake_credential_file "custom-stake.cred"
      assert_trace_value wallet_stake_script_credential_file \
        "custom-stake.script.cred"
      assert_trace_value wallet_derivation_file "custom-derivation.path"
      assert_trace_value wallet_drep_verification_file "custom-drep.vkey"
      assert_trace_value wallet_drep_signing_file "custom-drep.skey"
      assert_trace_value wallet_drep_hardware_file "custom-drep.hwsfile"
      assert_trace_value wallet_drep_id_file "custom-drep.id"
      assert_trace_value wallet_drep_script_file "custom-drep.script"
      assert_trace_value wallet_drep_register_file "custom-drep-reg.cert"
      assert_trace_value wallet_drep_retire_file "custom-drep-ret.cert"
