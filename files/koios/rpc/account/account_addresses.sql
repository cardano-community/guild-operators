DROP FUNCTION IF EXISTS koios.account_addresses (text);

CREATE FUNCTION koios.account_addresses (_address text DEFAULT NULL)
  RETURNS TABLE (
    address varchar)
  LANGUAGE PLPGSQL
  AS $$
...
COMMENT ON FUNCTION koios.account_addresses IS 'Get all addresses associated with an account';
