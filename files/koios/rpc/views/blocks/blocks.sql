DROP VIEW IF EXISTS koios.blocks;

CREATE VIEW koios.blocks AS
SELECT
...
COMMENT ON VIEW koios.blocks IS 'Get detailed information about all blocks (paginated - latest first)';
