DROP FUNCTION IF EXISTS koios.block_info (_block_hash text);

CREATE FUNCTION koios.block_info (_block_hash text)
  RETURNS TABLE (
    HASH text,
    EPOCH uinteger,
    ABS_SLOT uinteger,
...
COMMENT ON FUNCTION koios.block_info IS 'Get detailed information about a specific block';
