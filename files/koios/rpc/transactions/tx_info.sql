DROP FUNCTION IF EXISTS koios.tx_info (text[]);

CREATE FUNCTION koios.tx_info (_tx_hashes text[])
  RETURNS TABLE (
    tx_hash text,
    block_hash text,
...
COMMENT ON FUNCTION koios.tx_info IS 'Get information about transactions.';
